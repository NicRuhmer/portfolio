import { hasInjectionContext, getCurrentInstance, inject, unref, version, defineComponent, createElementBlock, h, computed, ref, Suspense, nextTick, provide, mergeProps, Transition, shallowReactive, watch, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, defineAsyncComponent, createVNode, resolveDynamicComponent, withCtx, reactive, effectScope, getCurrentScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, useSSRContext } from 'vue';
...
import { i as getContext, s as sanitizeStatusCode, j as baseURL, c as createError$1, k as createHooks, t as toRouteMatcher, l as createRouter$1 } from '../nitro/nitro.mjs';
...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-9E20nBNN.mjs');
...
const unhead_tHcDuQP8xA = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Cp4BgVlw.mjs')
  },
  {
    name: "projets",
    path: "/projets",
    component: () => import('./index-CVI8AlLp.mjs')
  }
];
...
const revive_payload_server_Du0Mxvel3H = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_tHcDuQP8xA,
  plugin,
  revive_payload_server_Du0Mxvel3H,
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="light-cursor"></div><div data-lenis-prevent></div>`);
      _push(ssrRenderComponent(_component_NuxtLayout, { class: "bg-bkg" }, {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-zsvKVNhq.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DTxdkJ_v.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.14.159_@parcel+watcher@2.5.0_@types+node@22.9.0_eslint@9.15.0_jiti@2.4.0__ioredis@5.4._md7ulalvrrinrnf4sawffzfdna/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.14.159_@parcel+watcher@2.5.0_@types+node@22.9.0_eslint@9.15.0_jiti@2.4.0__ioredis@5.4._md7ulalvrrinrnf4sawffzfdna/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { On as O, withoutTrailingSlash as a, useRuntimeConfig as b, useNuxtApp as c, nuxtLinkDefaults as d, entry$1 as default, withLeadingSlash as e, parseURL as f, defu as g, hasProtocol as h, encodeParam as i, joinURL as j, encodePath as k, injectHead as l, resolveUnrefHeadInput as m, navigateTo as n, br as o, parseQuery as p, resolveRouteObject as r, useRouter as u, withTrailingSlash as w };
